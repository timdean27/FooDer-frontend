...
const Price_Loc_sellec = ({ priceChange, locationChange, radiusChange, searchPrice , searchLocation, searchRadius }) => {
  let tickAry = [];
  for (let i = 5; i <= 24; i++) {
    tickAry.push(i);
  }
  ...
  return (
    <div className="price-slide-container">
      ...
      <input
        type="text"
        placeholder= {searchLocation? searchLocation : "Input the location you would like to search"}
